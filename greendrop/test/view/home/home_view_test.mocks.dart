...
// in greendrop/test/view/home/home_view_test.dart.
...
import 'package:greendrop/model/level.dart' as _i12;
import 'package:greendrop/model/task.dart' as _i6;
import 'package:greendrop/model/tree.dart' as _i4;
...
import 'package:greendrop/view-model/user_provider.dart' as _i5;
...
class _FakeTree_3 extends _i1.SmartFake implements _i4.Tree {
  _FakeTree_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockUserProvider extends _i1.Mock implements _i5.UserProvider {
  ...
  @override
  List<_i4.Tree> get userTrees =>
      (super.noSuchMethod(
            Invocation.getter(#userTrees),
            returnValue: <_i4.Tree>[],
          )
          as List<_i4.Tree>);
  ...
  @override
  _i9.Future<void> updateUserTreeInFirestore(_i4.Tree? updatedTree) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockTreeProvider extends _i1.Mock implements _i7.TreeProvider {
  MockTreeProvider() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i4.Tree get tree =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeTree_3(this, Invocation.getter(#tree)),
          )
          as _i4.Tree);
  ...
  @override
  List<_i12.Level> get levels =>
      (super.noSuchMethod(
            Invocation.getter(#levels),
            returnValue: <_i12.Level>[],
          )
          as List<_i12.Level>);
  ...
  @override
  set tree(_i4.Tree? _tree) => super.noSuchMethod(
  ...
  @override
  void waterTree(_i5.UserProvider? userProvider) => super.noSuchMethod(
